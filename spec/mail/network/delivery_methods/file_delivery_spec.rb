...
describe "SMTP Delivery Method" do
  ...
  describe "general usage" do
    ...
    it "should send an email to a file" do
      ...
      delivery = File.join(Mail.delivery_method.settings[:location], 'marcel@amont.com.log')
    ...
    it "should send multiple emails to multiple files" do
      ...
      delivery_one = File.join(Mail.delivery_method.settings[:location], 'marcel@amont.com.log')
      delivery_two = File.join(Mail.delivery_method.settings[:location], 'bob@me.com.log')
    ...
    it "should only create files based on the addr_spec of the destination" do
      ...
      delivery = File.join(Mail.delivery_method.settings[:location], 'mikel@test.lindsaar.net.log')
    ...
    it "should use the base name of the file name to prevent file system traversal" do
      ...
      delivery = File.join(Mail.delivery_method.settings[:location], 'pwn.log')
      File.exists?(delivery).should be_true
    end
